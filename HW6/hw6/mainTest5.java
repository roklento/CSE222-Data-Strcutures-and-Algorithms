...
public class mainTest5 {
    ...
    public static void run() {
        ...
        try {
            ...
            quickSort quickSort1 = new quickSort(myMap1);
            System.out.println("\nThe sorted map:");
        ...
        try {
            ...
            quickSort quickSort2 = new quickSort(myMap2);
            System.out.println("\nThe sorted map:");
            quickSort2.printSortedMap();
        }
        catch (Exception e) {
            System.out.println("Exception: " + e.getMessage());
        }
        ...
        try {
            ...
            quickSort quickSort3 = new quickSort(myMap3);
            System.out.println("\nThe sorted map:");
            quickSort3.printSortedMap();
        }
        catch (Exception e) {
            System.out.println("Exception: " + e.getMessage());
        }
    ...
    private static void bestCase() {
        ...
        for (int i = 0; i < 1000; i++) {
            ...
            quickSort quickSort4 = new quickSort(myMap4);
            time = quickSort4.runSort();
            result += time;
        }
