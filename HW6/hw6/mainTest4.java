...
public class mainTest4 {
    ...
    public static void run() {
        ...
        try {
            ...
            bubbleSort bubbleSort1 = new bubbleSort(myMap1);
            System.out.println("\nThe sorted map:");
        ...
        try {
            ...
            bubbleSort bubbleSort2 = new bubbleSort(myMap2);
            System.out.println("\nThe sorted map:");
            bubbleSort2.printSortedMap();
        }
        catch (Exception e) {
            System.out.println("Exception: " + e.getMessage());
        }
        ...
        try {
            ...
            bubbleSort bubbleSort3 = new bubbleSort(myMap3);
            System.out.println("\nThe sorted map:");
            bubbleSort3.printSortedMap();
        }
        catch (Exception e) {
            System.out.println("Exception: " + e.getMessage());
        }
    ...
    private static void bestCase() {
        ...
        for (int i = 0; i < 1000; i++) {
            ...
            bubbleSort bubbleSort4 = new bubbleSort(myMap4);
            time = bubbleSort4.runSort();
            result += time;
        }
