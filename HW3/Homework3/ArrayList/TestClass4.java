...
class TestClass4
{
    ...
    public static void main(String[] args)
    {
        ...
        Post post3 = new Post(3, 0, "Java the programming language...", new ArrayList<String>(), new ArrayList<Integer>());
        Post post4 = new Post(4, 0, "Java the island...", new ArrayList<String>(), new ArrayList<Integer>());
        Post post5 = new Post(5, 0, "Java the tea...", new ArrayList<String>(), new ArrayList<Integer>());
        Post post6 = new Post(6, 0, "I love C++", new ArrayList<String>(), new ArrayList<Integer>());
        Post post7 = new Post(7, 0, "I love C#", new ArrayList<String>(), new ArrayList<Integer>());
        Post post8 = new Post(8, 0, "I love Python", new ArrayList<String>(), new ArrayList<Integer>());
        Post post9 = new Post(9, 0, "I love Ruby", new ArrayList<String>(), new ArrayList<Integer>());
        Post post10 = new Post(10, 0, "I love JavaScript", new ArrayList<String>(), new ArrayList<Integer>());
