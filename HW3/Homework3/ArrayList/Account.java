...
class Account 
{
    ...
    private ArrayList<Account> blocksUser = new ArrayList<Account>();
    private ArrayList<String> showHistory = new ArrayList<String>();
    ...
    protected void addPost(Post post ,ArrayList<Account> accounts) 
    {
        if(this.isLogged())
        {
     ...
     * @param account
     */
    protected void logIn(ArrayList<Account> account) 
    {
     ...
     * @return
     */
    ArrayList<Account> getFollowers()
    {
        return followers;
    }
    /**
     ...
     * @return
     */
    ArrayList<Account> getFollowing() 
    {
        return following;
    }
    /**
     ...
     * @param isLogged
     */
    ArrayList<Account> getBlocksUser() 
    {
        return blocksUser;
    }
     ...
     * 
     */
    ArrayList<String> getShowHistory() 
    {
        return showHistory;
    }
    /**
