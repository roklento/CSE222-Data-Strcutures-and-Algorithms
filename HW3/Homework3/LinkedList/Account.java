...
class Account 
{
    ...
    private LinkedList<Post> post = new LinkedList<Post>();
    ...
    private LinkedList<String> outbox = new LinkedList<String>();
    private LinkedList<Account> blocksUser = new LinkedList<Account>();
    private LinkedList<String> showHistory = new LinkedList<String>();
    private LinkedList<Post> likedPosts = new LinkedList<Post>();
    ...
    protected void addPost(Post post ,LinkedList<Account> accounts) 
    {
        if(this.isLogged())
        {
     ...
     * @param account
     */
    protected void logIn(LinkedList<Account> account) 
    {
     ...
     * @return
     */
    LinkedList<Account> getFollowers()
    {
        return followers;
    }
    /**
     ...
     * @return
     */
    LinkedList<Account> getFollowing() 
    {
        return following;
    }
    /**
     ...
     * @param isLogged
     */
    LinkedList<Account> getBlocksUser() 
    {
        return blocksUser;
    }
     ...
     * 
     */
    LinkedList<String> getShowHistory() 
    {
        return showHistory;
    }
    /**
