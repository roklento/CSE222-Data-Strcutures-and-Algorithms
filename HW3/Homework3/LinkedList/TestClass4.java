...
class TestClass4
{
    ...
    public static void main(String[] args)
    {
        ...
        Post post1 = new Post(1, 0, "I like Java...", new LinkedList<String>(), new LinkedList<Integer>());
        Post post2 = new Post(2, 0, "Java the coffee...", new LinkedList<String>(), new LinkedList<Integer>());
        Post post3 = new Post(3, 0, "Java the programming language...", new LinkedList<String>(), new LinkedList<Integer>());
        Post post4 = new Post(4, 0, "Java the island...", new LinkedList<String>(), new LinkedList<Integer>());
        Post post5 = new Post(5, 0, "Java the tea...", new LinkedList<String>(), new LinkedList<Integer>());
        Post post6 = new Post(6, 0, "I love C++", new LinkedList<String>(), new LinkedList<Integer>());
        Post post7 = new Post(7, 0, "I love C#", new LinkedList<String>(), new LinkedList<Integer>());
        Post post8 = new Post(8, 0, "I love Python", new LinkedList<String>(), new LinkedList<Integer>());
        Post post9 = new Post(9, 0, "I love Ruby", new LinkedList<String>(), new LinkedList<Integer>());
        Post post10 = new Post(10, 0, "I love JavaScript", new LinkedList<String>(), new LinkedList<Integer>());
