...
class Post
{
    ...
    private LDLinkedList<String> comments = new LDLinkedList<String>();
    private LDLinkedList<Integer> likes = new LDLinkedList<Integer>();
    private LDLinkedList<Integer> commetsUsers = new LDLinkedList<Integer>();
     ...
     * @param likes
     */
    protected Post(int postId, int accountId, String content,LDLinkedList<String> comments, LDLinkedList<Integer> likes)
    {
        this.postId = postId;
     ...
     * @param accounts
     */
    protected void addLike(Like like , int accountID, LDLinkedList<Account> accounts)
    {
     ...
     * @param accounts
     */
    protected void removeLike(Like like , int accountID, LDLinkedList<Account> accounts)
    {
        // check account login with the given ID
        if (!accounts.get(accountID).isLogged())
        {
     ...
     * @param accounts
     */
    protected void addComment(Comment comment, int accountID ,LDLinkedList<Account> accounts)
    {
        // check account login with the given ID
        if (!accounts.get(accountID).isLogged())
        {
     ...
     * @param accounts
     */
    protected void removeComment(Comment comment, int accountID ,LDLinkedList<Account> accounts)
    {
        // check account login with the given ID
        if (!accounts.get(accountID).isLogged())
        {
     ...
     * @return
     */
    LDLinkedList<String> getComments()
    {
        return comments;
    }
    /**
     ...
     * @return
     */
    LDLinkedList<Integer> getCommetsUsers()
    {
        return commetsUsers;
    }
}