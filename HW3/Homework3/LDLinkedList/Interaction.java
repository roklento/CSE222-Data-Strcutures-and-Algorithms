...
class Interaction
{
    ...
    private int postId;
    private LDLinkedList<Account> account;
    /**
     * 
     * @param interactionId
     * @param accountId
     ...
     * @param account
     */
    protected Interaction(int interactionId, int accountId, int postId, LDLinkedList<Account> account)
    {
    ...
    protected void interect()
    {
        ...
        LDLinkedList<String> tempLikes = new LDLinkedList<String>();
        LDLinkedList<String> tempComment = new LDLinkedList<String>();
        LDLinkedList<String> tempCommetsUsers = new LDLinkedList<String>();
     ...
     * @return
     */
    LDLinkedList<Account> getAccount()
    {
        return account;
    }
